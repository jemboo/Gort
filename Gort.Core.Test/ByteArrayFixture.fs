...
type ByteArrayFixture () =
    ...
    member this.getUint64fromBytes () =
        ...
        let blobIn = [| uintV |] |> (ByteArray.mapUint64sToBytes 0 1 blobIn offset) |> Result.ExtractOrThrow
        let uintVback = blobIn |> ByteArray.getUint64fromBytes offset |> Result.ExtractOrThrow
