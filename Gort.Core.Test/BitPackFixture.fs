...
type BitPackFixture () =
    ...
    member this.fromIntArrays () =
        ...
        let bitPack = sortedArrays 
                        |> BitPack.fromIntArrays symbolSetSize
                        |> Result.ExtractOrThrow

        let sortedArraysBack = bitPack 
                                |> BitPack.toIntArrays arrayLen
                                |> Result.ExtractOrThrow
    ...
    member this.fromBoolArrays () =
        ...
        let bytePack = boolArrays 
                        |> BitPack.fromBoolArrays
                        |> Result.ExtractOrThrow


        let boolArraysBack = bytePack 
