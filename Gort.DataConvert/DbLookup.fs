...
module DbLookup =
    ...
    let GetBitPackRById (gortCtxt: IGortContext2) (bitPackRId: int) =
        ...
        with ex ->
            ("error in GetBitPackRById: " + ex.Message) |> Result.Error
    ...
    let GetRandGenRById (gortCtxt: IGortContext2) (rndGenId: int) =
        ...
        with ex ->
            ("error in GetRandGenRById: " + ex.Message) |> Result.Error
    ...
    let GetSortableSetRById (gortCtxt: IGortContext2) (sortableSetRId: int) =
        ...
        with ex ->
            ("error in GetSortableSetRById: " + ex.Message) |> Result.Error
    ...
    let GetSorterRById (gortCtxt: IGortContext2) (sorterRId: int) =
        ...
        with ex ->
            ("error in GetSorterRById: " + ex.Message) |> Result.Error
    ...
    let GetSorterSetRById (gortCtxt: IGortContext2) (sorterSetRId: int) =
        ...
        with ex ->
            ("error in GetSorterSetRById: " + ex.Message) |> Result.Error
