...
namespace Gort.Data
{
    public static class MetaDataUtils
    {
        ...
        public static CauseParam GetOrMakeCauseParam(CauseParamType cpt, byte[] value, GortContext? gortContext = null)
        {
            var ctxt = gortContext ?? new GortContext();
            var id = GuidUtils.guidFromObjs(new object[2] { cpt.CauseParamTypeId, value });
